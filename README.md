...
* String: [Stringx.java] ([Test][StringxTest.java]) | [Stringx.kt] ([Test][StringxTest.kt])
    ...
    * reversed, filter, filterBlank, removeChar removeIndex
...
* Collection: [Collectionx.java] | [Collectionx.kt]
    * isEmpty, isNotEmpty, orEmpty, listOf, arrayListOf, linkedListOf, onlyReadListOf,
    * createEmptyList, createEmptySet, createEmptyStack, createEmptyQueue, createEmptyDeque,
    * collectionSizeOrDefault, filter, map, flatMap, join, count, average, sum, first, last, find, get, max, min,
    * addAll, removeAll, partition, toCollection, toList, toSet, toHashSet,
