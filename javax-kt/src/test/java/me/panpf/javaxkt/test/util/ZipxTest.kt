...
import me.panpf.javaxkt.util.getZipDecompressDstDir
import me.panpf.javaxkt.util.zipCompressDir
import me.panpf.javaxkt.util.zipDecompress
...
class ZipxTest {
    ...
    fun testCompression() {
        ...
        val dstFile = dir.zipCompressDir()

        dstFile.getZipDecompressDstDir().deleteRecursively()
        val decompressionDstDir = dstFile.zipDecompress()
