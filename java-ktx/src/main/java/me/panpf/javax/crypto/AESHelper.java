...
public class AESHelper {
    ...
    private AESHelper(@NotNull Key key, @Nullable String mode, @Nullable String padding) {
        this.key = key;
        this.mode = mode;
    ...
    public static Key keyFromBase64(@NotNull String passwordBase64) {
        return new SecretKeySpec(Base64Kt.base64DecodeToBytes(passwordBase64), ALGORITHM);
    }
     ...
     */
    @NotNull
    public byte[] encrypt(@NotNull byte[] textBytes) throws InvalidKeyException,
     ...
     */
    @NotNull
    public byte[] encrypt(@NotNull String text) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
    ...
    public String encryptToBase64(@NotNull byte[] textBytes) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
        return Base64Kt.base64EncodeToString(encrypt(textBytes));
    }
    ...
    public String encryptToBase64(@NotNull String text) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
        return Base64Kt.base64EncodeToString(encrypt(text.getBytes()));
    }
     ...
     */
    @NotNull
    public String decrypt(@NotNull byte[] cipherTextBytes) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
     ...
     */
    @NotNull
    public String decrypt(@NotNull String cipherText) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
    ...
    public String decryptFromBase64(@NotNull byte[] cipherTextBytes) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
        return decrypt(Base64Kt.base64DecodeToBytes(cipherTextBytes));
    }
    ...
    public String decryptFromBase64(@NotNull String cipherText) throws InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
        return decrypt(Base64Kt.base64DecodeToBytes(cipherText.getBytes()));
    }
